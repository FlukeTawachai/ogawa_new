...
class CountPerCountReportSort extends StatefulWidget {
  const CountPerCountReportSort({Key? key}) : super(key: key);

  @override
  State<CountPerCountReportSort> createState() =>
      _CountPerCountReportSortState();
}

class _CountPerCountReportSortState extends State<CountPerCountReportSort> {
                ...
                child: TextButton(
                  onPressed: () {
                    ...
                    if (sortCountRepNo == true) {
                      if (aTz == true) {
                        // ApiProxyParameter.dataListF.sort((a, b) => a
                        //     .countReportNo
                        //     .toString()
                        //     .compareTo(b.countReportNo.toString()));

                        ApiProxyParameter.dataListF.sort((a, b) {
                          int cmp = a.countReportNo
                              .toString()
                              .compareTo(b.countReportNo.toString());
                          if (cmp != 0) return cmp;

                          return a.countReportSeq
                              .toString()
                              .compareTo(b.countReportSeq.toString());
                        });
                      } else if (zTa == true) {
                        // ApiProxyParameter.dataListF.sort((a, b) => b
                        //     .countReportNo
                        //     .toString()
                        //     .compareTo(a.countReportNo.toString()));

                        ApiProxyParameter.dataListF.sort((a, b) {
                          int cmp = b.countReportNo
                              .toString()
                              .compareTo(a.countReportNo.toString());
                          if (cmp != 0) return cmp;

                          return b.countReportSeq
                              .toString()
                              .compareTo(a.countReportSeq.toString());
                        });
                      }
                      ...
                      if (aTz == true) {
                        ApiProxyParameter.dataListF.sort((a, b) => a.locationNo
                            .toString()
                            .compareTo(b.locationNo.toString()));
                      } else if (zTa == true) {
                        ApiProxyParameter.dataListF.sort((a, b) => b.locationNo
                            .toString()
