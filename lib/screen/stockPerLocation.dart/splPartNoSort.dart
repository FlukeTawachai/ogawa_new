...
class SplPartNoSort extends StatefulWidget {
  final CommonResp data;

  const SplPartNoSort({Key? key, required this.data}) : super(key: key);

  @override
  State<SplPartNoSort> createState() => _SplPartNoSortState();
}

class _SplPartNoSortState extends State<SplPartNoSort> {
  bool sortLotNo = true;
              ...
              child: ButtonTheme(
                ...
                child: TextButton(
                  onPressed: () {
                    ...
                    if (sortLotNo == true) {
                      if (aTz == true) {
                        ApiProxyParameter.splPartNo.sort((a, b) =>
                      ...
                      if (aTz == true) {
                        ApiProxyParameter.splPartNo.sort(
                    ...
                    Navigator.pushReplacement<void, void>(
                      ...
                      MaterialPageRoute<void>(
                        builder: (BuildContext context) =>
                            StockPerLocationPartNo(
                                data: widget.data, reset: false),
                      ),
                    );
                  },
                  child: const Center(
