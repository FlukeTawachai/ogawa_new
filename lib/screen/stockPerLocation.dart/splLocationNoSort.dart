...
class SplLocationNoSort extends StatefulWidget {
  const SplLocationNoSort({Key? key}) : super(key: key);

  @override
  State<SplLocationNoSort> createState() => _SplLocationNoSortState();
}

class _SplLocationNoSortState extends State<SplLocationNoSort> {
  bool sortPartNo = true;
          ...
          Expanded(
            child: Container(
              ...
              child: ButtonTheme(
                ...
                child: TextButton(
                  onPressed: () {
                    // print("*********** Location No: $sortPartNo");
                    // print("*********** Onhand : $sortOnHand");
                    // print("*********** A TO z: $aTz");
                    // print("*********** Z TO A: $zTa");
                    if (sortPartNo == true) {
                      if (aTz == true) {
                        ApiProxyParameter.splPartLocationNo.sort((a, b) =>
                      ...
                      if (aTz == true) {
                        ApiProxyParameter.splPartLocationNo.sort(
